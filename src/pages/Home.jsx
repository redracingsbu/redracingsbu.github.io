...
function Home() {
  ...
  const heroOpacityStyle = useMemo(
    () => ({ opacity: scrollOpacity }),
    [scrollOpacity],
  );
  ...
  const scrollToMission = useCallback(() => {
    if (missionRef.current) {
      const elementPosition =
        missionRef.current.getBoundingClientRect().top + window.scrollY;
        ...
        <div className="flex items-start rr-page-pad pb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-36 w-full max-w-[1400px] mx-auto">
            ...
            <div className="max-w-3xl mx-auto lg:mx-0 lg:ml-12 w-full flex flex-col justify-center order-1 lg:order-none">
              <h1 className="rr-h1 mb-8 text-left">About Us</h1>

              <div className="space-y-4 rr-body">
                <p>
                  RedRacing is Stony Brook's First Formula SAE team, founded in
                  2025 in a dorm room by a group of new engineering students who
                  shared a love for Formula 1 and high-performance vehicles.
                </p>

                <p>
                  As new college students, we didn't know much, but we knew two
                  things for certain: we wanted to pursue the technical
                  challenge of a true formula-style car, and we wanted to build
                  a team where students could learn hands-on from day one.
                </p>

                <p>
                  What started as a few freshmen with an idea has evolved into a
                  cross-disciplinary organization of over 30 mechanical,
                  electrical, computer, software, physics, chemistry, and
                  business students united around one goal: design, build, and
                  compete with a Formula SAE vehicle on the international stage.
                </p>
              </div>
            </div>
